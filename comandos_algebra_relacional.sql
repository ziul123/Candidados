...
SELECT politico.nome AS Nome, nomeCargo, orgao.nome AS Orgao FROM politico, exerceCargoEm, orgao WHERE CPF = politicoCPF AND codOrg = orgaoCodOrg;

-- Seleciona Nome, Âmbito, Município e Estado de cada politico
SELECT politico.nome, ambito, municipio, estado FROM politico, exerceCargoEm, orgao, candidados.local
